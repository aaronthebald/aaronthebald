### Hello there 👋
My name is Aaron Wilson. I am a self-taught iOS Developer. I love building apps and solving problems! I have experience contributing to open-source projects, working on a contractor for the SaaS company [TrackHero](https://trackhero.com), and building personal projects. 
...
My Dog Days allows users to track events in the life of their dog. It is built  with SwiftUI and Core Data. Users are reminded of their events with local notifications. Availble on the [App Store](https://apps.apple.com/hu/app/my-dog-days/id6463662341). Check out the [Repo](https://github.com/aaronthebald/DogDays1)!

Cake is an app that allows users to browse recipes of popular desserts from [TheMealDB](https://www.themealdb.com). Network requests were made with Async/Await, and unit tests were written using XCTest. Check out the [Repo](https://github.com/aaronthebald/Cake)
